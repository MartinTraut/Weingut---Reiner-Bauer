...
export default function About() {
  return (
    <section id="weingut" className="relative section-padding bg-gradient-dark">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-20 md:mb-28">
          ...
          <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl lg:text-6xl text-cream tracking-wide">
            Ein Weingut,{" "}
            <span className="italic text-gold/80">eine Familie</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <ScrollReveal direction="left" className="relative">
            <div className="relative aspect-[4/5] overflow-hidden">
              <Image
                ...
                alt="Familie Bauer — Martin, Tanja und Bärbel Bauer stoßen mit eigenen Weinen an"
                fill
              ...
              <div className="absolute inset-0 flex items-end p-8 md:p-12">
                <div>
                  ...
                  <p className="font-[family-name:var(--font-playfair)] text-6xl md:text-7xl text-cream/80">
                    1989
                  </p>
                </div>
              </div>
          ...
          <StaggerContainer className="space-y-8">
            <StaggerItem>
              <p className="font-[family-name:var(--font-cormorant)] text-xl md:text-2xl text-cream/80 leading-relaxed">
            ...
            <StaggerItem>
              <p className="font-[family-name:var(--font-cormorant)] text-lg md:text-xl text-cream/60 leading-relaxed">
            ...
            <StaggerItem>
              <div className="flex items-center gap-6 mt-8 pt-8 border-t border-gold/10">
                <div className="text-center">
                  ...
                  <p className="font-[family-name:var(--font-inter)] text-[10px] tracking-[0.3em] uppercase text-cream/40 mt-1">
                    Hektar
                  </p>
                </div>
