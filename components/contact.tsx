              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-[family-name:var(--font-cormorant)] text-lg text-cream/70 hover:text-gold transition-colors duration-300 block"
                  >
                    0 71 33 / 96 04 20
                  </a>
                  <p className="font-[family-name:var(--font-cormorant)] text-base text-cream/50">
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-[family-name:var(--font-cormorant)] text-lg text-cream/70 hover:text-gold transition-colors duration-300"
                  >
                    [email protected]
                  </a>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b border-gold/20 focus:border-gold/60 py-3 text-cream font-[family-name:var(--font-cormorant)] text-lg outline-none transition-colors duration-300 placeholder:text-cream/25"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-transparent border-b border-gold/20 focus:border-gold/60 py-3 text-cream font-[family-name:var(--font-cormorant)] text-lg outline-none transition-colors duration-300 appearance-none cursor-pointer"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border-b border-gold/20 focus:border-gold/60 py-3 text-cream font-[family-name:var(--font-cormorant)] text-lg outline-none transition-colors duration-300 resize-none placeholder:text-cream/25"
