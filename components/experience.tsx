...
export default function Experience() {
  return (
    <section id="erlebnis" className="relative section-padding bg-gradient-wine overflow-hidden">
      {/* Decorative */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-20 md:mb-28">
          ...
          <h2 className="font-[family-name:var(--font-playfair)] text-4xl md:text-5xl lg:text-6xl text-cream tracking-wide">
            Das{" "}
            <span className="italic text-gold/80">Erlebnis</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-8 md:gap-10">
          ...
          <ScrollReveal delay={0}>
            <div className="group h-full p-8 md:p-10 border border-gold/10 hover:border-gold/25 transition-all duration-700 bg-warmblack/30 flex flex-col">
              <div className="mb-6">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="w-8 h-8 text-gold/50">
              ...
              <p className="font-[family-name:var(--font-cormorant)] text-lg text-cream/50 leading-relaxed mb-8 flex-1">
              ...
              <div className="border-t border-gold/10 pt-6 space-y-3">
                <div className="flex justify-between">
                  <span className="font-[family-name:var(--font-inter)] text-[12px] text-cream/40">
                    Mo – Fr
                  </span>
          ...
          <ScrollReveal delay={0.15}>
            <div className="group h-full p-8 md:p-10 border border-gold/10 hover:border-gold/25 transition-all duration-700 bg-warmblack/30 flex flex-col">
              ...
              <div className="border-t border-gold/10 pt-6">
                <p className="font-[family-name:var(--font-inter)] text-[11px] tracking-[0.15em] text-cream/40">
          ...
          <ScrollReveal delay={0.3}>
            <div className="group h-full p-8 md:p-10 border border-gold/15 hover:border-gold/30 transition-all duration-700 bg-wine-dark/10 flex flex-col relative overflow-hidden">
              {/* Highlight badge */}
              ...
              <p className="font-[family-name:var(--font-inter)] text-[11px] tracking-[0.15em] text-gold/60 mb-4">
                6. & 7. März 2026
              </p>
              <p className="font-[family-name:var(--font-cormorant)] text-lg text-cream/50 leading-relaxed mb-8 flex-1">
              ...
              <div className="border-t border-gold/10 pt-6">
                <p className="font-[family-name:var(--font-inter)] text-[11px] tracking-[0.15em] text-cream/40 mb-3">
                  Tickets per E-Mail
                </p>
                <a
                  href="mailto:[email protected]?subject=KellerKücheKlang Tickets"
                  className="inline-block font-[family-name:var(--font-inter)] text-[12px] tracking-[0.2em] uppercase text-warmblack bg-gold hover:bg-gold-light px-8 py-3 transition-all duration-500"
                >
                  Tickets anfragen
                </a>
              </div>
        ...
        <ScrollReveal className="mt-20 text-center">
          <div className="inline-flex items-center gap-4 border border-gold/10 px-8 py-4 bg-warmblack/20">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="w-5 h-5 text-gold/40 shrink-0">
              <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
              <circle cx="12" cy="10" r="3" />
            </svg>
            <p className="font-[family-name:var(--font-cormorant)] text-lg text-cream/50">
              Direkt an der{" "}
              <span className="text-gold/70 italic">
